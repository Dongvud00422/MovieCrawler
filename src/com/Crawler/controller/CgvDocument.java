...
public class CgvDocument {
    ...
    public Document loadDocument(String target) throws IOException {

        return Jsoup.connect(target)
                .requestBody("TS015ef8cd_id=3&TS015ef8cd_cr=783cd6cbd7faa22bcbf2f90aedd6fd99%3Axzxz%3A85CbHbVV%3A168162141&TS015ef8cd_76=0&TS015ef8cd_md=1&TS015ef8cd_rf=0&TS015ef8cd_ct=0&TS015ef8cd_pd=0")
                .post();
    }
